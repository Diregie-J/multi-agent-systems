...
class Ui_MainWindow(QObject):
    def setupUi(self, MainWindow):
        ...
        self.defaultEnergyBoxPushButton = QtWidgets.QPushButton(self.frame_2)
        self.defaultEnergyBoxPushButton.setObjectName("defaultEnergyBoxPushButton")
        self.verticalLayout_15.addWidget(self.defaultEnergyBoxPushButton)
        self.defaultEgotismPushButton = QtWidgets.QPushButton(self.frame_2)
        self.defaultEgotismPushButton.setObjectName("defaultEgotismPushButton")
        self.verticalLayout_15.addWidget(self.defaultEgotismPushButton)
        self.defaultSusceptibilityPushButton = QtWidgets.QPushButton(self.frame_2)
        self.defaultSusceptibilityPushButton.setObjectName("defaultSusceptibilityPushButton")
        self.verticalLayout_15.addWidget(self.defaultSusceptibilityPushButton)
        self.defaultIdealismPushButton = QtWidgets.QPushButton(self.frame_2)
        self.defaultIdealismPushButton.setObjectName("defaultIdealismPushButton")
        self.verticalLayout_15.addWidget(self.defaultIdealismPushButton)
        self.defaultFairnessPushButton = QtWidgets.QPushButton(self.frame_2)
        self.defaultFairnessPushButton.setObjectName("defaultFairnessPushButton")
        self.verticalLayout_15.addWidget(self.defaultFairnessPushButton)
        ...
        self.defaultEnergyBoxPushButton.clicked.connect(self.defaultEnergyBoxSlot)
        self.defaultEgotismPushButton.clicked.connect(self.defaultEgotismSlot)
        self.defaultSusceptibilityPushButton.clicked.connect(self.defaultSusceptibilitySlot)
        self.defaultIdealismPushButton.clicked.connect(self.defaultIdealismSlot)
        self.defaultFairnessPushButton.clicked.connect(self.defaultFairnessSlot)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.defaultHealthPushButton.setText(_translate("MainWindow", "Average Energy"))
        ...
        self.defaultEnergyBoxPushButton.setText(_translate("MainWindow", "Energy Distribution"))
        self.defaultEgotismPushButton.setText(_translate("MainWindow", "Average Egotism"))
        self.defaultSusceptibilityPushButton.setText(_translate("MainWindow", "Average Susceptibility"))
        self.defaultIdealismPushButton.setText(_translate("MainWindow", "Average Idealism"))
        self.defaultFairnessPushButton.setText(_translate("MainWindow", "Average Fairness"))
